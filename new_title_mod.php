...
$result=mysql_query("select id,cost_price,distribution_price from store_master where item_or_lang='$l_or_i_val' ");
...
<?php
echo "<form action='modify_stock_update.php?rn=$row_number' method='post'>";
...
echo "<td><center>"." <input type='text' disabled='disabled' value=$arr[$k] id=$k name=$k>"."</center> </td>";
